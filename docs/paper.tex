...
comparison against OR-Tools is iso-time. On 400 customers, Hybrid-DDQN achieves a
statistically significant vehicle-count reduction over ALNS-Base ($23.33$ vs.\
$23.79$, Wilcoxon $p=1.4{\times}10^{-3}$ across the 24 instances) and, at matched
fleet size, reduces travel distance by $7.86\%$ on average across the 11
matched-fleet instances. On 600 customers the mean vehicle count drops from
