...
\textbf{Anytime budget.} The search additionally accepts a wall-clock budget,
derived per instance as $0.6\,\text{s} \times n$ unless set explicitly. The main
...
distance quality and therefore must not be truncated. This makes the comparison
against OR-Tools, which is itself run under a fixed $120$\,s limit, an iso-time
one; the iteration-bounded protocol used previously left the two methods on
different budgets.
...
$r1\_2\_1$ & $20/4784.11$
  ...
  & \textbf{$20/+0.79\%$}   & $22/\text{--}{}^\dagger$\\
$r2\_2\_1$ & $4/4483.16$
  & $5/\text{--}{}^\dagger$   & $5/\text{--}{}^\dagger$  & $5/\text{--}{}^\dagger$
  & \textbf{$5/\text{--}{}^\dagger$}  & $5/\text{--}{}^\dagger$\\
$rc1\_2\_1$ & $18/3602.80$
  & $19/\text{--}{}^\dagger$  & $19/\text{--}{}^\dagger$ & $19/\text{--}{}^\dagger$
  & \textbf{$19/\text{--}{}^\dagger$} & $19/\text{--}{}^\dagger$\\
$rc2\_2\_1$ & $6/3099.53$
  & $6/+7.14\%$             & $6/+3.87\%$            & $6/+2.87\%$
  & \textbf{$6/+2.56\%$}    & $7/\text{--}{}^\dagger$\\
\bottomrule
\end{tabular}}
\end{table*}
