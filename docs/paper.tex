...
Hybrid-DDQN achieves $+0.139$ overall mean NV difference to BKS on Solomon---representing a $13.7\%$ improvement over ALNS-Base ($+0.161$) and a $92.7\%$ improvement over OR-Tools ($+1.911$).  Wilcoxon signed-rank tests (per-run paired, $N=310$) across the benchmark set confirm vehicle count reduction is highly significant against OR-Tools ($p=2.731{\times}10^{-9}$, $W=0.0$, effect size $r=0.750$) and ALNS-Base ($p=1.431{\times}10^{-2}$, $W=0.0$, effect size $r=0.130$).
...
\midrule
Clustered ($N=17$)     & 0.000 & 0.000 & 0.000 & \textbf{0.000} & 0.059\\
Short horizon ($N=20$) & 0.350 & 0.350 & 0.350 & \textbf{0.340} & 2.450\\
Wide horizon ($N=19$)  & 0.105 & 0.105 & 0.074 & \textbf{0.053} & 3.000\\
\midrule
Overall mean           & 0.161 & 0.161 & 0.150 & \textbf{0.139} & 1.911\\
\bottomrule
\end{tabular}}
\end{table}
...
(b)~\emph{strict fair intersection} ($N=47$): all hybrids simultaneously at
$NV\le NV_{\BKS}$.
...
\midrule
Algo-specific
  & $+0.220\%\ (N{=}47)$ & $+0.218\%\ (N{=}47)$
  & $+0.215\%\ (N{=}47)$ & \textbf{$+0.230\%$} $(N{=}48)$\\
Fair intersection
  & $+0.220\%$ & $+0.218\%$ & $+0.215\%$ & \textbf{$+0.204\%$}\\
\bottomrule
\end{tabular}}
\end{table}

\Cref{tab:fair_by_category} disaggregates by family.
The wide-horizon gap narrows from $+0.533\%$ (ALNS-Base) to
$\mathbf{+0.502\%}$ (Hybrid-DDQN), a $5.8\%$ reduction attributable to
convergent intra-route $2$-opt and Or-opt polishing.

\begin{table}[!t]
\centering
\caption{Strict fair intersection ($N=47$) by Solomon family.}
...
\midrule
Clustered ($N=17$)
  & $0.000\%$ & $0.000\%$ & $0.000\%$ & \textbf{$0.000\%$}\\
Short horizon ($N=13$)
  & $+0.100\%$ & $+0.093\%$ & $+0.085\%$ & \textbf{$+0.082\%$}\\
Wide horizon ($N=17$)
  & $+0.533\%$ & $+0.531\%$ & $+0.529\%$ & \textbf{$+0.502\%$}\\
\midrule
Overall ($N=47$)
  & $+0.220\%$ & $+0.218\%$ & $+0.215\%$ & \textbf{$+0.204\%$}\\
\bottomrule
...
$c2\_2\_1$ & $6/1931.44$
  ...
  & \textbf{$6/+0.00\%$}    & $7/+0.19\%$\\
$r1\_2\_1$ & $20/4795.12$
  & $20/+0.57\%$            & $20/+0.57\%$           & $20/+0.57\%$
  & \textbf{$20/+0.57\%$}   & $26/+2.59\%$\\
$r2\_2\_1$ & $4/4483.00$
  & $5/-9.41\%{}^\dagger$   & $5/-9.44\%{}^\dagger$  & $5/-9.53\%{}^\dagger$
  & \textbf{$5/-9.57\%{}^\dagger$}  & $12/-19.96\%{}^\dagger$\\
$rc1\_2\_1$ & $18/3603.00$
  & $19/-0.98\%{}^\dagger$  & $19/-0.98\%{}^\dagger$ & $19/-0.98\%{}^\dagger$
  & \textbf{$19/-0.98\%{}^\dagger$} & $21/+5.54\%$\\
$rc2\_2\_1$ & $6/3099.00$
  & $6/+1.32\%$             & $6/+1.32\%$            & $6/+1.32\%$
  & \textbf{$6/+1.32\%$}    & $11/-4.43\%{}^\dagger$\\
\bottomrule
\end{tabular}}
\end{table*}
