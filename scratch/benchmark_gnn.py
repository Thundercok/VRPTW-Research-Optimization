...
def run_test():
    ...
    cfg = Config(
        hybrid_iterations=800,  # moderate iteration count for quick benchmarking
        segment_size=100,
    ...
    print("==========================================================================")
    print("  RUNNING SOTA GNN VS. BASELINE COMPARISON BENCHMARK")
    print("==========================================================================")
    ...
    for name in instances:
        ...
        rows.append({
            ...
            "Base TD": f"{base_td_avg:.1f}",
            "GNN TD": f"{gnn_td_avg:.1f}",
            "Base Time (s)": f"{base_time_avg:.1f}",
            "GNN Time (s)": f"{gnn_time_avg:.1f}"
        })
