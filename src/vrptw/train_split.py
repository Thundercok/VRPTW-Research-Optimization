...
from .config import Config, default_data_path, default_output_dir
from .core import Inst, Plan
from .generators import load_datasets
from .split_controller import SplitController, extract_giant_tour, DEVICE


def load_elite_plans(folder: str, insts_dict: dict[str, Inst]) -> list[Plan]:
    plans = []
...
def main():
    ...
    parser.add_argument("--elite-path", type=str, default="./elite_plans", help="Path to elite JSON solutions")
