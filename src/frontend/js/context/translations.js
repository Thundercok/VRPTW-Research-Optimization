export const APP_COPY = {
  en: {
    ...
    mapPlayground: 'AI Playground',
    mapShowGNN: 'GNN Heatmap',
    mapOverlay: 'Overlay',
    mapDriverApp: 'Driver App',
    ...
    mapOverlayEmpty: 'Run the optimizer to pick an overlay',
    kpiGapTitleBks: 'Gap to Best-Known Solution',
    kpiGapTitleBaseline: 'Gap vs Baseline',
    kpiGapBks: 'Total distance vs BKS',
    kpiGapBaseline: 'Total distance vs',
    kpiGapIsBaseline: 'This overlay is the baseline',
    kpiNotRun: 'Not run yet',
    kpiVsBaseline: 'vs baseline',
    kpiFleetUsed: 'Used / fleet provided',
    kpiTimeParallel: 'Wall clock, solvers run in parallel',
    thId: 'ID',
    thName: 'Name',
    thAddress: 'Address',
    thLat: 'Lat',
  ...
  vn: {
    ...
    mapShowGNN: 'Heatmap GNN',
    mapOverlay: 'Lớp phủ',
    mapDriverApp: 'App tài xế',
    ...
    mapOverlayEmpty: 'Chạy tối ưu để chọn lớp phủ',
    kpiGapTitleBks: 'Chênh Lệch So Với BKS',
    kpiGapTitleBaseline: 'Chênh Lệch So Với Baseline',
    kpiGapBks: 'Tổng quãng đường so với BKS',
    kpiGapBaseline: 'Tổng quãng đường so với',
    kpiGapIsBaseline: 'Lớp phủ này chính là baseline',
    kpiNotRun: 'Chưa chạy',
    kpiVsBaseline: 'so với baseline',
    kpiFleetUsed: 'Đã dùng / đội xe được cấp',
    kpiTimeParallel: 'Thời gian thực, các solver chạy song song',
    thId: 'ID',
    thName: 'Tên',
    thAddress: 'Địa chỉ',
    thLat: 'Vĩ độ',
