export const APP_COPY = {
  ...
  vn: {
    ...
    liveDispatch: 'Điều Phối Trực Tiếp',
    fleetConfig: 'Cấu Hình Đội Xe',
    intelligenceLabel: 'Trí Tuệ Nhân Tạo',
    modelAnalytics: 'Phân Tích Mô Hình',
    ...
    vehiclesLabel: 'Số xe: ',
    capacityLabel: 'Tải trọng: ',
    executeSolver: 'Chạy Solver',
    langButton: 'EN',
    backToDemo: 'Demo',
